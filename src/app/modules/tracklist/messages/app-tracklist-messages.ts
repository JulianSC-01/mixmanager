export class AppTracklistMessages {
  ...
  public static MSG_REMOVE_SINGLE_SUCCESSFUL : string              = "Successfully removed '{0}'.";
  public static MSG_REMOVE_TRACK_MULTIPLE_SUCCESSFUL : string      = "Successfully removed {0} tracks.";
